...
# if(not os.path.isdir('Google')):
#     os.mkdir('Google')
#     print('Tao thanh con thu muc Google')

# RootDir = os.getcwd()
# print(RootDir)

# htmlPath = RootDir + '/00PutFileIndexHere/index.html'
# htmlPathAfterBuild = RootDir + '/Google/index.html'
...
def simpleImSoLazy(html_file_name, html_target):
    with open(html_file_name, "r") as f:
        ...
        strTarget0 = r'window.$environment={baseUrl:"./",resourceConfig:{json:"inline",image:"inline",video:"inline",sound:"compress",blob:"compress"},packageConfig:Object.assign({inlineScripts:!1,inlineJsons:!1,inlineBlobs:!1,inlineImages:!1,inlineSounds:!0,inlineVideos:!1,applicationName:"",iosLink:"",androidLink:"",orientation:"unspecified",languages:["en","en"]},window.LUNA_PLAYGROUND_PACKAGE_CONFIG||{}),playerPrefs:!0,usingWebWorkers:"off",targetPlatform:"google",runtimeAnalysisModules:["physics3d","physics2d","particle_system","reflection","prefabs","mecanim-wasm"]}'
        ...
        strTarget5 = r'window.addEventListener("luna:build",(function(){window.pi.logLoaded(),window.dispatchEvent(new Event("luna:unsafe:mute")),window.dispatchEvent(new Event("luna:start"))}))'
        strTarget6 = r'window.addEventListener("luna:build",(()=>{Bridge.ready((()=>{Luna.Unity.Playable.InstallFullGame=function(){window.ExitApi.exit()}}))}))'
...
def reFixMetaTagMeta2(html_file_name):
    with open(html_file_name, "r") as f:
        ...
        mystring41 = r'<meta name="ad.orientation" content="portrait,landscape">'
...
def makeAdsFolder():
    if(not os.path.isdir(GlobalVarible.targetPath_Now + '/Google')):
        os.mkdir(GlobalVarible.targetPath_Now + '/Google')
        print('Tao thanh con thu muc Google')
